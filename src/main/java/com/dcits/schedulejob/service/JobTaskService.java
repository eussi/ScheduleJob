...
public class JobTaskService {
    ...
    @Autowired
    private DomainDao<ScheduleJob> domainDao;
    ...
    public ScheduleJob getTaskById(String jobId) {
        return domainDao.selectByPrimaryKey(jobId);
    }
    ...
    public void changeStatus(String jobId, String cmd) throws SchedulerException {
        ...
        domainDao.updateByPrimaryKeySelective(job);
    }
    ...
    public void init() throws Exception {
        ...
        // 这里获取任务信息数据
        List<ScheduleJob> jobList = domainDao.getAll();
